...
if (isset($_GET['page'])) {
	$page = $_GET['page'];
	  ...
	  if($searchnum<>""){$sqlstr=$sqlstr." and mk_product.productno='".$searchnum."'";}
	...
	$phpfile="chooseproduct.php?searchtitle=$searchtitle&searchnum=$searchnum&getid=$getid&getname=$getname&page=";	
	$pagearray=pagenumstr($page,$total,$phpfile,$pagenum,$pagelen);
    $pageinfo=$pagearray['pagecode'];		
	
$tl->set_file('chooseproduct');
$tl->n();
$tl->p();
$db->close();
?>